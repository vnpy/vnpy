...
- 买入情况：若最新Tick卖一价低于目标价格，执行撤单；若无活动委托则发出委托，委托数量在剩余委托量与预定挂出委托量中取最小值。

- 卖出情况：若新Tick买一价高于目标价格，执行撤单；若无活动委托则发出委托，委托数量在剩余委托量与预定挂出委托量中取最小值。
...
- 买入情况：先检查撤单：最新Tick买一价不等于目标价格时，执行撤单；若无活动委托，发出委托，委托价格为最新Tick买一价，委托数量为随机生成数量（在最小委托量与最大委托量区间）与剩余委托量之间取最小值。

- 卖出情况：先检查撤单：最新Tick买一价不等于目标价格时，执行撤单；若无活动委托，发出委托，委托价格为最新Tick卖一价，委托数量为随机生成数量（在最小委托量与最大委托量区间）与剩余委托量之间取最小值。
