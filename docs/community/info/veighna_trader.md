...
【微信通知】窗口中的【推送设置】区域提供了【最小间隔】配置，用于控制两次微信推送之间的最小时间间隔。若在间隔内产生多条通知，程序会先暂存这些消息，并在下一次推送时合并为一条发送，从而降低短时间内触达微信机器人发送阈值的风险。

微信机器人存在推送额度限制：用户每发送1条消息，机器人可在24小时内推送10条消息；超限后需要用户再次向机器人发送消息才能恢复。因此，建议根据策略通知频率适当调大【最小间隔】，避免短时间内频繁推送。

绑定信息和推送设置会保存到.vntrader\wechat_setting.json文件中，后续启动VeighNa Trader时会自动加载。
