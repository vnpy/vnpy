...
class Korbit_TradeApi(object):
    ...
    def request_get(self, url, headers=None, params=None):
        response = requests.get(
            url, headers=headers, params=params, timeout=self.__timeout
        )
        try:
            return response.json()
        except json.decoder.JSONDecodeError as e:
    ...
    def processRequest(self, req):
        ...
        kwargs = req["kwargs"]
        if method in [
            KORBITFUNCTIONCODE_LIMIT_BID_ORDER,
            KORBITFUNCTIONCODE_LIMIT_ASK_ORDER,
            KORBITFUNCTIONCODE_CANCEL_ORDER,
        ]:
            ...
            KORBITFUNCTIONCODE_LIST_EXCHANGE_ORDERS,
            KORBITFUNCTIONCODE_BALANCES,
        ]:
    ...
    def buy_currency(self, coin_amount, price, currency_pair="btc_krw"):
        ...
        return self.sendRequest(
            korbit_host + "user/orders/buy",
            KORBITFUNCTIONCODE_LIMIT_BID_ORDER,
            self.on_buy_currency,
            kwargs=kwargs,
            optional=None,
        )
    ...
    def sell_currency(self, coin_amount, price, currency_pair="btc_krw"):
        ...
        return self.sendRequest(
            korbit_host + "user/orders/sell",
            KORBITFUNCTIONCODE_LIMIT_ASK_ORDER,
            self.on_sell_currency,
            kwargs=kwargs,
            optional=None,
        )
    ...
    def list_market_orders(self, currency_pair="btc_krw", offset=0, limit=50):
        ...
        return self.sendRequest(
            korbit_host + "user/orders",
            KORBITFUNCTIONCODE_LIST_EXCHANGE_ORDERS,
            self.on_list_exchange_orders,
            kwargs=kwargs,
            optional=None,
        )
    ...
    def cancel_orders(self, order_id, currency_pair="btc_krw"):
        ...
        return self.sendRequest(
            korbit_host + "user/orders/cancel",
            KORBITFUNCTIONCODE_CANCEL_ORDER,
            self.onCancelOrders,
            kwargs=kwargs,
            optional=None,
