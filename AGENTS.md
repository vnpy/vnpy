...
## Strategy Production Index

Keep this section as an index plus quick commands. Put durable strategy lessons
in the linked docs/skill references instead of expanding AGENTS.md with long
run history.

- Strategy production skill: `/Users/miaoyuhan/.codex/skills/strategy-production/SKILL.md`
- Acceptance pipeline: `docs/strategy_testing_pipeline.md`
- Chan original design: `docs/plans/2026-05-21-chan-strategy-design.md`
- Chan implementation plan: `docs/plans/2026-05-21-chan-strategy.md`
- Chan automation readiness: `docs/plans/2026-05-22-chan-auto-trading-readiness.md`
- Generic sizing design: `docs/plans/2026-05-23-target-position-sizing-design.md`
- Generic sizing implementation: `docs/plans/2026-05-23-target-position-sizing.md`
- Current Chan sell completion work: `docs/plans/2026-05-24-chan-sell-completion.md`
- OKX runtime troubleshooting: `docs/troubleshooting/okx-auto-trading.md`

Quick local strategy gates:
```bash
...
Current operational stance: passing acceptance makes Chan a backtest/paper
candidate, not automatically live-ready. Keep runtime defaults signal-only
unless DEMO order mode, risk caps, health, account freshness, and notification
mode have all been explicitly verified.
