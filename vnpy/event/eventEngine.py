...
class EventEngine(object):
    ...
    def __init__(self):
        ...
        # 事件处理线程
        self.__thread = Thread(target = self.__run, name='EventEngine_run')
...
class EventEngine2(object):
    ...
    def __init__(self):
        ...
        # 事件处理线程
        self.__thread = Thread(target = self.__run, name='event_process')
        
        # 计时器，用于触发计时器事件
        self.__timer = Thread(target = self.__runTimer, name='event_timer_process')
