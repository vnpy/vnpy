...
class GatewayApi(BitfinexApi):
    ...
    def subscribe(self, symbol, channel):
        """"""
        req = {"event": "subscribe", "channel": channel, "symbol": symbol}
        self.sendReq(req)
    ...
    def authenticate(self):
        ...
        signature = hmac.new(
            self.secretKey.encode(), msg=authPayload.encode(), digestmod=hashlib.sha384
        ).hexdigest()
    ...
    def cancelOrder(self, cancelOrderReq):
        ...
        req = [0, "oc", None, {"cid": orderId, "cid_date": date}]
