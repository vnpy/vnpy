...
class CshshlpTdApi(CsHsHlp):
    ...
    def onQryContract(self, data, reqNo, errorNo, errorInfo):
        ...
        for d in data:
            ...
            contract.exchange = exchangeMapReverse.get(
                d["exchange_type"], EXCHANGE_UNKNOWN
            )
    ...
    def onQryOrder(self, data, reqNo, errorNo, errorInfo):
        ...
        for d in data:
            ...
            order.exchange = exchangeMapReverse.get(
                d["exchange_type"], EXCHANGE_UNKNOWN
            )
            ...
            order.direction = directionMapReverse.get(
                d["entrust_bs"], DIRECTION_UNKNOWN
            )
    ...
    def onQryPosition(self, data, reqNo, errorNo, errorInfo):
        ...
        for d in data:
            ...
            pos.direction = posDirectionMapReverse.get(
                d["opthold_type"], DIRECTION_UNKNOWN
            )
    ...
    def connect(self, opEntrustWay, opStation, fundAccount, password):
        ...
        self.opStation = "TYJR-%s-IIP.%s-LIP.%s-MAC.%s-HD.%s-PCN.%s-CPU.%s-PI.%s" % (
            opStation,
            iip,
            lip,
            mac,
