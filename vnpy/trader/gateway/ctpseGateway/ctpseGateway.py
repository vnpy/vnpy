...
from vnpy.trader.gateway.ctpseGateway.language import text
from vnpy.trader.gateway.ctpseGateway.ctpDataType import *
...
########################################################################
class CtpseGateway(VtGateway):
    """CTP接口"""

    #----------------------------------------------------------------------
    def __init__(self, eventEngine, gatewayName='CTPSE'):
        """Constructor"""
        super(CtpseGateway, self).__init__(eventEngine, gatewayName)
...
def test():
    ...
    gateway = CtpseGateway(eventEngine)
