...
class DrEngine(object):
    ...
    def loadSetting(self):
        ...
        with open(self.settingFilePath) as f:
            ...
            if "tick" in drSetting:
                ...
                for setting in l:
                    ...
                    if vtSymbol not in self.settingDict:
                        d = {"symbol": symbol, "gateway": gateway, "tick": True}
            ...
            if "active" in drSetting:
                d = drSetting["active"]
                self.activeSymbolDict = {
                    vtSymbol: activeSymbol for activeSymbol, vtSymbol in d.items()
                }
    ...
    def processTimerEvent(self, event):
        ...
        if (
            self.lastTimerTime < self.marketCloseTime
            and currentTime >= self.marketCloseTime
        ):
            # 强制所有的K线生成器立即完成K线
    ...
    def onTick(self, tick):
        ...
        if vtSymbol in self.tickSymbolSet:
            ...
            self.writeDrLog(
                text.TICK_LOGGING_MESSAGE.format(
    ...
    def onBar(self, bar):
        ...
        self.writeDrLog(
            text.BAR_LOGGING_MESSAGE.format(
                symbol=bar.vtSymbol,
                time=bar.time,
                open=bar.open,
                high=bar.high,
