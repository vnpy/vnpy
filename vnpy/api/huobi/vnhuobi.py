...
class TradeApi(object):
    ...
    def apiGet(self, path, params):
        ...
        params["Signature"] = createSign(
            params, method, self.hostname, path, self.secretKey
        )
    ...
    def apiPost(self, path, params):
        ...
        signParams["Signature"] = createSign(
            signParams, method, self.hostname, path, self.secretKey
        )
...
class DataApi(object):
    ...
    def subTopic(self, topic):
        ...
        self.reqid += 1
        req = {"sub": topic, "id": str(self.reqid)}
        self.sendReq(req)
    ...
    def unsubTopic(self, topic):
        ...
        if topic not in self.subDict:
            return
        req = {"unsub": topic, "id": self.subDict[topic]}
        self.sendReq(req)
