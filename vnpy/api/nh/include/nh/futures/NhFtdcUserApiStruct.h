...
#if !defined(NH_FTDCSTRUCT_H)
#define NH_FTDCSTRUCT_H

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000

#include "NhFtdcUserApiDataType.h"
...
struct CThostFtdcReqUserLoginField
{
	...
	///App代码
	TThostFtdcAppIDType	UserProductInfo;
	///认证码
	TThostFtdcAuthCodeType	InterfaceProductInfo;
	///协议信息
