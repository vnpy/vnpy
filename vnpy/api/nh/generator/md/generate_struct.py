...
class StructGenerator:
    ...
    def process_end(self, line: str):
        ...
        if "_t" not in self.current_struct:
            self.f_struct.write(f"{self.current_struct}_t = {self.current_struct}\n\n")
...
if __name__ == "__main__":
    generator = StructGenerator("../../include/nh/md/NHUserApiStruct.h", "nh")
    generator.run()
