...
#include "nh/futures/NhFtdcTraderApi.h"
...
//API的继承实现
class FuturesTdApi : public CThostFtdcTraderSpi
{
private:
...
public:
	...
	void createFuturesTdApi(string flowPath);
	...
	void registerFensUserInfo(const dict &data);
