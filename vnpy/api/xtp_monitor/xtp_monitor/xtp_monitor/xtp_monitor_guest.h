...
public:
	...
	typedef int(*MonitorClientLoginFunc)(const char* username, const char* password, const char* mac_add, const char* ip);
	...
	typedef int(*MonitorClientSetParameterFunc)(const char* key, const char* value);
