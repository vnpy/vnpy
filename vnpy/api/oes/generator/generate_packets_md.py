...
class Generator:
    ...
    def run(self):
        ...
        self.f_define = open(f"{self.prefix}_constant_mkt_packets_md.py", "w")
        self.f_typedef = open(f"{self.prefix}_typedef_mkt_packets_md.py", "w")
        self.f_struct = open(f"{self.prefix}_struct_mkt_packets_md.py", "w")
    ...
    def load_struct(self):
        """加载Struct"""
        module_name = "oes_struct_mkt_packets_md"
...
if __name__ == "__main__":
    generator = Generator("../include_for_generator/oes/mds_mkt_packets.h", "oes")
    generator.run()
