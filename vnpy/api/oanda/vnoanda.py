...
class OandaApi(object):
    ...
    def init(self, settingName, token, accountId):
        ...
        self.initFunctionSetting(
            FUNCTIONCODE_GETINSTRUMENTS, {"path": "/v1/instruments", "method": "GET"}
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETPRICES, {"path": "/v1/prices", "method": "GET"}
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETPRICEHISTORY, {"path": "/v1/candles", "method": "GET"}
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETACCOUNTS, {"path": "/v1/accounts", "method": "GET"}
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETACCOUNTINFO,
            {"path": "/v1/accounts/%s" % self.accountId, "method": "GET"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETORDERS,
            {"path": "/v1/accounts/%s/orders" % self.accountId, "method": "GET"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_SENDORDER,
            {"path": "/v1/accounts/%s/orders" % self.accountId, "method": "POST"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETORDERINFO,
            {"path": "/v1/accounts/%s/orders" % self.accountId, "method": "GET"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_MODIFYORDER,
            {"path": "/v1/accounts/%s/orders" % self.accountId, "method": "PATCH"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_CANCELORDER,
            {"path": "/v1/accounts/%s/orders" % self.accountId, "method": "DELETE"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETTRADES,
            {"path": "/v1/accounts/%s/trades" % self.accountId, "method": "GET"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETTRADEINFO,
            {"path": "/v1/accounts/%s/trades" % self.accountId, "method": "GET"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_MODIFYTRADE,
            {"path": "/v1/accounts/%s/trades" % self.accountId, "method": "PATCH"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_CLOSETRADE,
            {"path": "/v1/accounts/%s/trades" % self.accountId, "method": "DELETE"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETPOSITIONS,
            {"path": "/v1/accounts/%s/positions" % self.accountId, "method": "GET"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETPOSITIONINFO,
            {"path": "/v1/accounts/%s/positions" % self.accountId, "method": "GET"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_CLOSEPOSITION,
            {"path": "/v1/accounts/%s/positions" % self.accountId, "method": "DELETE"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETTRANSACTIONS,
            {"path": "/v1/accounts/%s/transactions" % self.accountId, "method": "GET"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETTRANSACTIONINFO,
            {"path": "/v1/accounts/%s/transactions" % self.accountId, "method": "GET"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETACCOUNTHISTORY,
            {
        ...
        self.initFunctionSetting(
            FUNCTIONCODE_GETCALENDAR, {"path": "/labs/v1/calendar", "method": "GET"}
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETPOSITIONRATIOS,
            {"path": "/labs/v1/historical_position_ratios", "method": "GET"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETSPREADS, {"path": "/labs/v1/spreads", "method": "GET"}
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETCOMMIMENTS,
            {"path": "/labs/v1/commitments", "method": "GET"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETORDERBOOK,
            {"path": "/labs/v1/orderbook_data", "method": "GET"},
        )

        self.initFunctionSetting(
            FUNCTIONCODE_GETAUTOCHARTIST,
            {"path": "/labs/v1/autochartist", "method": "GET"},
        )
        ...
        self.initFunctionSetting(
            FUNCTIONCODE_STREAMPRICES, {"path": "/v1/prices", "method": "GET"}
        )

        self.initFunctionSetting(
            FUNCTIONCODE_STREAMEVENTS, {"path": "/v1/events", "method": "GET"}
        )
    ...
    def getInstruments(self, params):
        ...
        return self.sendRequest(
            FUNCTIONCODE_GETINSTRUMENTS, params, self.onGetInstruments
        )
    ...
    def getPriceHisory(self, params):
        """查询历史价格数据"""
        return self.sendRequest(
            FUNCTIONCODE_GETPRICEHISTORY, params, self.onGetPriceHistory
        )
    ...
    def getOrderInfo(self, optional):
        """查询委托信息"""
        return self.sendRequest(
            FUNCTIONCODE_GETORDERINFO, {}, self.onGetOrderInfo, optional
        )
    ...
    def modifyOrder(self, params, optional):
        """修改委托"""
        return self.sendRequest(
            FUNCTIONCODE_MODIFYORDER, params, self.onModifyOrder, optional
        )
    ...
    def cancelOrder(self, optional):
        """查询委托信息"""
        return self.sendRequest(
            FUNCTIONCODE_CANCELORDER, {}, self.onCancelOrder, optional
        )
    ...
    def getTradeInfo(self, optional):
        """查询仓位信息"""
        return self.sendRequest(
            FUNCTIONCODE_GETTRADEINFO, {}, self.onGetTradeInfo, optional
        )
    ...
    def modifyTrade(self, params, optional):
        """修改仓位"""
        return self.sendRequest(
            FUNCTIONCODE_MODIFYTRADE, params, self.onModifyTrade, optional
        )
    ...
    def closeTrade(self, optional):
        """平仓"""
        return self.sendRequest(
            FUNCTIONCODE_CLOSETRADE, {}, self.onCloseTrade, optional
        )
    ...
    def getPositionInfo(self, optional):
        """查询汇总仓位信息"""
        return self.sendRequest(
            FUNCTIONCODE_GETPOSITIONINFO, {}, self.onGetPositionInfo, optional
        )
    ...
    def closePosition(self, optional):
        """平仓汇总仓位信息"""
        return self.sendRequest(
            FUNCTIONCODE_CLOSEPOSITION, {}, self.onClosePosition, optional
        )
    ...
    def getTransactions(self, params):
        """查询所有资金变动"""
        return self.sendRequest(
            FUNCTIONCODE_GETTRANSACTIONS, params, self.onGetTransactions
        )
    ...
    def getTransactionInfo(self, optional):
        """查询资金变动信息"""
        return self.sendRequest(
            FUNCTIONCODE_GETTRANSACTIONINFO, {}, self.onGetTransactionInfo, optional
        )
    ...
    def getAccountHistory(self):
        """查询账户资金变动历史"""
        return self.sendRequest(
            FUNCTIONCODE_GETACCOUNTHISTORY, {}, self.onGetAccountHistory
        )
    ...
    def getPositionRatios(self, params):
        """查询持仓比例"""
        return self.sendRequest(
            FUNCTIONCODE_GETPOSITIONRATIOS, params, self.onGetPositionRatios
        )
    ...
    def getCommitments(self, params):
        """查询交易商持仓情况"""
        return self.sendRequest(
            FUNCTIONCODE_GETCOMMIMENTS, params, self.onGetCommitments
        )
    ...
    def getAutochartist(self, params):
        """查询Autochartist识别的模式"""
        return self.sendRequest(
            FUNCTIONCODE_GETAUTOCHARTIST, params, self.onGetAutochartist
        )
    ...
    def processStreamPrices(self):
        ...
        params = {"accountId": self.accountId, "instruments": ",".join(symbols)}
        req = {
            "url": self.streamDomain + setting["path"],
            "method": setting["method"],
            "params": params,
            "stream": True,
        }
