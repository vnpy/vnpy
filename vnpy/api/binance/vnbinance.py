...
class BinanceApi(object):
    ...
    def startStream(self):
        ...
        return self.addReq(
            "POST", path, {}, self.onStartStream, signed=True, stream=True
        )
    ...
    def keepaliveStream(self, listenKey):
        ...
        return self.addReq(
            "PUT", path, params, self.onKeepaliveStream, signed=True, stream=True
        )
    ...
    def closeStream(self, listenKey):
        ...
        params = {"listenKey": listenKey}
        return self.addReq(
            "DELETE", path, params, self.onCloseStream, signed=True, stream=True
        )
