...
virtual void onRspRequestVertificateCode(string userNo, unsigned int nSessionID, int nErrorCode, char last, const dict &data) {};
...
virtual void onRspSubmitUserLoginInfo(string userNo, unsigned int nSessionID, const dict &data) {};

virtual void onRspChangePassword(string userNo, unsigned int nSessionID, int nErrorCode) {};

virtual void onRspSetReservedInfo(string userNo, unsigned int nSessionID, int nErrorCode, string info) {};
