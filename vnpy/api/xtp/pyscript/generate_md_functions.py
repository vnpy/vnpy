...
fcpp = open(os.path.join(XTP_API_PATH,'xtpapi','xtp_quote_api.h'), 'rb')
ftask = open(os.path.join(XTP_API_PATH,'xtp_md_task.cpp'), 'w',encoding='utf-8')
fprocess = open(os.path.join(XTP_API_PATH,'xtp_md_process.cpp'), 'w',encoding='utf-8')
ffunction = open(os.path.join(XTP_API_PATH,'xtp_md_function.cpp'), 'w',encoding='utf-8')
fdefine = open(os.path.join(XTP_API_PATH,'xtp_md_define.cpp'), 'w',encoding='utf-8')
fswitch = open(os.path.join(XTP_API_PATH,'xtp_md_switch.cpp'), 'w',encoding='utf-8')
fheaderprocess = open(os.path.join(XTP_API_PATH,'xtp_md_header_process.h'), 'w',encoding='utf-8')
fheaderon = open(os.path.join(XTP_API_PATH,'xtp_md_header_on.h'), 'w',encoding='utf-8')
fheaderfunction = open(os.path.join(XTP_API_PATH,'xtp_md_header_function.h'), 'w',encoding='utf-8')
fwrap = open(os.path.join(XTP_API_PATH,'xtp_md_wrap.cpp'), 'w',encoding='utf-8')
