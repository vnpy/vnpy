...
{'OnDisconnected': 'virtual void OnDisconnected(int reason) ', 'OnError': 'virtual void OnError(XTPRI *error_info) ', 'OnSubMarketData': 'virtual void OnSubMarketData(XTPST *ticker, XTPRI *error_info, bool is_last) ', 'OnUnSubMarketData': 'virtual void OnUnSubMarketData(XTPST *ticker, XTPRI *error_info, bool is_last) ', 'OnDepthMarketData': 'virtual void OnDepthMarketData(XTPMD *market_data, int64_t bid1_qty[], int32_t bid1_count, int32_t max_bid1_count, int64_t ask1_qty[], int32_t ask1_count, int32_t max_ask1_count) ', 'OnSubOrderBook': 'virtual void OnSubOrderBook(XTPST *ticker, XTPRI *error_info, bool is_last) ', 'OnUnSubOrderBook': 'virtual void OnUnSubOrderBook(XTPST *ticker, XTPRI *error_info, bool is_last) ', 'OnOrderBook': 'virtual void OnOrderBook(XTPOB *order_book) ', 'OnSubTickByTick': 'virtual void OnSubTickByTick(XTPST *ticker, XTPRI *error_info, bool is_last) ', 'OnUnSubTickByTick': 'virtual void OnUnSubTickByTick(XTPST *ticker, XTPRI *error_info, bool is_last) ', 'OnTickByTick': 'virtual void OnTickByTick(XTPTBT *tbt_data) ', 'OnSubscribeAllMarketData': 'virtual void OnSubscribeAllMarketData(XTP_EXCHANGE_TYPE exchange_id, XTPRI *error_info) ', 'OnUnSubscribeAllMarketData': 'virtual void OnUnSubscribeAllMarketData(XTP_EXCHANGE_TYPE exchange_id, XTPRI *error_info) ', 'OnSubscribeAllOrderBook': 'virtual void OnSubscribeAllOrderBook(XTP_EXCHANGE_TYPE exchange_id, XTPRI *error_info) ', 'OnUnSubscribeAllOrderBook': 'virtual void OnUnSubscribeAllOrderBook(XTP_EXCHANGE_TYPE exchange_id, XTPRI *error_info) ', 'OnSubscribeAllTickByTick': 'virtual void OnSubscribeAllTickByTick(XTP_EXCHANGE_TYPE exchange_id, XTPRI *error_info) ', 'OnUnSubscribeAllTickByTick': 'virtual void OnUnSubscribeAllTickByTick(XTP_EXCHANGE_TYPE exchange_id, XTPRI *error_info) ', 'OnQueryAllTickers': 'virtual void OnQueryAllTickers(XTPQSI* ticker_info, XTPRI *error_info, bool is_last) ', 'OnQueryTickersPriceInfo': 'virtual void OnQueryTickersPriceInfo(XTPTPI* ticker_info, XTPRI *error_info, bool is_last) ', 'OnSubscribeAllOptionMarketData': 'virtual void OnSubscribeAllOptionMarketData(XTP_EXCHANGE_TYPE exchange_id, XTPRI *error_info) ', 'OnUnSubscribeAllOptionMarketData': 'virtual void OnUnSubscribeAllOptionMarketData(XTP_EXCHANGE_TYPE exchange_id, XTPRI *error_info) ', 'OnSubscribeAllOptionOrderBook': 'virtual void OnSubscribeAllOptionOrderBook(XTP_EXCHANGE_TYPE exchange_id, XTPRI *error_info) ', 'OnUnSubscribeAllOptionOrderBook': 'virtual void OnUnSubscribeAllOptionOrderBook(XTP_EXCHANGE_TYPE exchange_id, XTPRI *error_info) ', 'OnSubscribeAllOptionTickByTick': 'virtual void OnSubscribeAllOptionTickByTick(XTP_EXCHANGE_TYPE exchange_id, XTPRI *error_info) ', 'OnUnSubscribeAllOptionTickByTick': 'virtual void OnUnSubscribeAllOptionTickByTick(XTP_EXCHANGE_TYPE exchange_id, XTPRI *error_info) '}
