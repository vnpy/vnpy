...
void TdApi::processTask()
{
    ...
    {
        cout << "TdApi processTask exception: " << e.what() << endl;
    }
};
...
void TdApi::processRspOrderInsert(Task *task)
{
	...
	try
	{
	    cout << "TdApi:processRspOrderInsert" << endl;
        if (task->task_data)
        {
...
void TdApi::processRspQryTradingAccount(Task *task)
{
	gil_scoped_acquire acquire;
	dict data;
	cout << "TdApi::processRspQryTradingAccount" << endl;
	if (task->task_data)
	{
...
void TdApi::processRtnTrade(Task *task)
{
	gil_scoped_acquire acquire;
	dict data;
	cout << "TdApi:processRtnTrade" << endl;
	if (task->task_data)
	{
		CThostFtdcTradeField *task_data = (CThostFtdcTradeField*)task->task_data;
		data["BrokerID"] = toUtf(task_data->BrokerID);
