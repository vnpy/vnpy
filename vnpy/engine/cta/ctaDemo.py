...
from vnpy.utils.vtConstant import EMPTY_STRING, EMPTY_FLOAT
...
class DoubleEmaDemo(CtaTemplate):
    ...
    def onInit(self):
        ...
        init_data = self.loadBar(self.initDays)
        for bar in init_data:
            self.onBar(bar)
    ...
    def onBar(self, bar):
        ...
        # 判断买卖
        cross_over = self.fastMa0 > self.slowMa0 and self.fastMa1 < self.slowMa1  # 金叉上穿
        cross_below = self.fastMa0 < self.slowMa0 and self.fastMa1 > self.slowMa1  # 死叉下穿
