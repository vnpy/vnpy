...
class CtaTemplate(object):
    ...
    def sendOrder(self, orderType, price, volume, stop=False):
        ...
        if self.trading:
            ...
            if stop:
                vt_order_id = self.ctaEngine.sendStopOrder(self.vtSymbol, orderType, price, volume, self)
            else:
                vt_order_id = self.ctaEngine.sendOrder(self.vtSymbol, orderType, price, volume, self)
            return vt_order_id
        else:
            # 交易停止时发单返回空字符串
            return ''
