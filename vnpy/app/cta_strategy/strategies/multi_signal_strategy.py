...
class RsiSignal(CtaSignal):
    ...
    def on_bar(self, bar: BarData,rsi_window , rsi_level):
        """
...
class CciSignal(CtaSignal):
    ...
    def on_bar(self, bar: BarData,cci_window,cci_level):
        """
        Callback of new bar data update.
        """
...
class MaSignal(CtaSignal):
    ...
    def on_bar(self, bar: BarData,fast_window,slow_window):
        """
        Callback of new bar data update.
        """
...
class MultiSignalStrategy(TargetPosTemplate):
    ...
    def on_bar(self, bar: BarData):
        ...
        self.rsi_signal.on_bar(bar,self.rsi_window,self.rsi_level)
        self.cci_signal.on_bar(bar,self.cci_window,self.cci_level)
        self.ma_signal.on_bar(bar,self.fast_window, self.slow_window)
