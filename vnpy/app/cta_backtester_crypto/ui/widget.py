...
class BacktesterManager(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.symbol_line = QtWidgets.QLineEdit("XBTZ19.BITMEX")
        self.symbol_line_2 = QtWidgets.QLineEdit("XBTU19.BITMEX")
        ...
        form.addRow("本地代码1", self.symbol_line)
        form.addRow("本地代码2", self.symbol_line_2)
    ...
    def start_backtesting(self):
        ...
        vt_symbol_2 = self.symbol_line_2.text()
