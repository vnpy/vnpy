...
ORDERTYPE_KAISA2VT[1] = OrderType.LIMIT
ORDERTYPE_KAISA2VT[3] = OrderType.MARKET
ORDERTYPE_KAISA2VT[4] = OrderType.MARKET
ORDERTYPE_KAISA2VT[5] = OrderType.STOP
ORDERTYPE_KAISA2VT[6] = OrderType.LIMIT
ORDERTYPE_KAISA2VT["lightning"] = OrderType.MARKET
ORDERTYPE_KAISA2VT["optimal_5"] = OrderType.MARKET
ORDERTYPE_KAISA2VT["optimal_10"] = OrderType.MARKET
ORDERTYPE_KAISA2VT["optimal_20"] = OrderType.MARKET
...
OFFSET_KAISA2VT = {v: k for k, v in OFFSET_VT2KAISA.items()}
...
class KaisaGateway(BaseGateway):
    ...
    def __init__(self, event_engine):
        ...
        self.rest_api = KaisaRestApi(self)
...
class KaisaRestApi(RestClient):
    ...
    def query_history(self, req: HistoryRequest):
        ...
        params = {
            "symbol": ws_symbol,
            "period": INTERVAL_VT2KAISA[req.interval],
            "size": 2000
        }
    ...
    def send_order(self, req: OrderRequest):
        ...
        data = {
            ...
            "direction": DIRECTION_VT2KAISA.get(req.direction, ""),
            "offset": OFFSET_VT2KAISA.get(req.offset, ""),
            "order_price_type": ORDERTYPE_VT2KAISA.get(req.type, ""),
            "lever_rate": 20
        }
        ...
        for d in data["data"]:
            ...
            if not position:
                position = PositionData(
                    ...
                    direction=DIRECTION_KAISA2VT[d["direction"]],
                    gateway_name=self.gateway_name
                )
    ...
    def on_query_order(self, data, request):
        ...
        for d in data["data"]["orders"]:
            ...
            order = OrderData(
                ...
                price=d["price"],
                volume=d["volume"],
                type=ORDERTYPE_KAISA2VT[d["order_price_type"]],
                direction=DIRECTION_KAISA2VT[d["direction"]],
                offset=OFFSET_KAISA2VT[d["offset"]],
                traded=d["trade_volume"],
                status=STATUS_KAISA2VT[d["status"]],
                time=time,
                gateway_name=self.gateway_name,
            )
            self.gateway.on_order(order)
...
class KaisaTradeWebsocketApi(KaisaWebsocketApiBase):
    ...
    def on_order(self, data: dict):
        ...
        order = OrderData(
            ...
            offset=OFFSET_KAISA2VT[data["offset"]],
            price=data["price"],
            volume=data["volume"],
