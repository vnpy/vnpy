...
from vnpy.app.option_riskmanager import OptionRiskApp
from vnpy.app.option_riskmanager.engine_rm import MainEngineRm
...
def main():
    ...
    main_engine = MainEngineRm(event_engine)
