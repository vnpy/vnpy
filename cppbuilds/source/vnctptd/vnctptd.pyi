...
class CThostFtdcQryStrikeOffsetField:
    ...
    ...
class CThostFtdcInputLockField:
    BrokerID: str
    InvestorID: str
    InstrumentID: str
    LockRef: str
...
class CThostFtdcQryLockField:
    ...
    ...
class CThostFtdcLockPositionField:
    BrokerID: str
    InvestorID: str
    InstrumentID: str
    ExchangeID: str
    ...
    ...
class CThostFtdcQryLockPositionField:
    BrokerID: str
    InvestorID: str
    InstrumentID: str
    ExchangeID: str
    ...
    ...
class CThostFtdcETFOptionInstrCommRateField:
    InstrumentID: str
    InvestorRange: int
    BrokerID: str
    InvestorID: str
    ...
    ...
class CThostFtdcQryETFOptionInstrCommRateField:
    BrokerID: str
    InvestorID: str
    InstrumentID: str
    ExchangeID: str
    ...
    ...
class CThostFtdcPosiFreezeField:
    BrokerID: str
    InvestorID: str
    InstrumentID: str
    ExchangeID: str
    ...
    InstallID: int
    Volume: int
    FreezeReasonType: int
    FreezeType: int
    
    ...
class CThostFtdcQryExchangeLockField:
    ParticipantID: str
    ClientID: str
    ExchangeInstID: str
    ExchangeID: str
    ...
    ...
class CThostFtdcExchangeLockField:
    Volume: int
    RequestID: int
    BusinessUnit: str
    LockType: int
    ...
    ...
class CThostFtdcExchangeExecOrderActionErrorField:
    ExchangeID: str
    ExecOrderSysID: str
    TraderID: str
    InstallID: int
...
class CThostFtdcQryBatchOrderActionField:
    ...
    ...
class CThostFtdcLimitPosiField:
    BrokerID: str
    InvestorID: str
    InstrumentID: str
    ExchangeID: str
    ...
    LongAmountFrozen: float
    
    ...
class CThostFtdcQryLimitPosiField:
    BrokerID: str
    InvestorID: str
    InstrumentID: str
    ExchangeID: str
    ...
    ...
class CThostFtdcBrokerLimitPosiField:
    BrokerID: str
    InstrumentID: str
    ExchangeID: str
    TotalVolume: float
    LongVolume: float
    TotalVolumeFrozen: float
    LongVolumeFrozen: float
    
    ...
class CThostFtdcQryBrokerLimitPosiField:
    BrokerID: str
    InstrumentID: str
    ExchangeID: str
    
    ...
class CThostFtdcLimitPosiSField:
    BrokerID: str
    InvestorID: str
    InstrumentID: str
    ExchangeID: str
    ...
    ...
class CThostFtdcQryLimitPosiSField:
    BrokerID: str
    InvestorID: str
    InstrumentID: str
    ExchangeID: str
    ...
    ...
class CThostFtdcLimitPosiParamField:
    InstrumentID: str
    InvestorRange: int
    BrokerID: str
    InvestorID: str
    ...
    ...
class CThostFtdcBrokerLimitPosiParamField:
    BrokerID: str
    InstrumentID: str
    ExchangeID: str
    TotalVolume: float
    ...
    ...
class CThostFtdcLimitPosiParamSField:
    InstrumentID: str
    InvestorRange: int
    BrokerID: str
    InvestorID: str
    ...
    ...
class CThostFtdcInputStockDisposalActionField:
    BrokerID: str
    InvestorID: str
    StockDisposalActionRef: int
    StockDisposalRef: str
    RequestID: int
    FrontID: int
    SessionID: int
    ExchangeID: str
    StockDisposalSysID: str
    ActionFlag: int
    UserID: str
    InstrumentID: str
    
    ...
class CThostFtdcStockDisposalActionField:
    BrokerID: str
    InvestorID: str
    StockDisposalActionRef: int
    StockDisposalRef: str
    ...
    ...
class CThostFtdcQryStockDisposalActionField:
    BrokerID: str
    InvestorID: str
    ExchangeID: str
    
    ...
class CThostFtdcExchangeStockDisposalActionField:
    ExchangeID: str
    StockDisposalSysID: str
    ActionFlag: int
    ActionDate: str
    ...
    ...
class CThostFtdcQryExchangeStockDisposalActionField:
    ParticipantID: str
    ClientID: str
    ExchangeID: str
    TraderID: str
    ...
    ...
class CThostFtdcQryErrStockDisposalActionField:
    BrokerID: str
    InvestorID: str
    
    ...
class CThostFtdcExchangeStockDisposalActionErrorField:
    ExchangeID: str
    StockDisposalSysID: str
    TraderID: str
    InstallID: int
    ...
    ...
class CThostFtdcErrStockDisposalActionField:
    BrokerID: str
    InvestorID: str
    StockDisposalActionRef: int
    StockDisposalRef: str
    ...
    ...
class CThostFtdcInvestorLevelField:
    BrokerID: str
    InvestorID: str
    ExchangeID: str
    LevelType: int
...
class CThostFtdcQryProductExchRateField:
    ...
    ...
class CThostFtdcInputDesignateField:
    BrokerID: str
    InvestorID: str
    DesignateRef: str
    UserID: str
    ...
    ...
class CThostFtdcDesignateField:
    BrokerID: str
    InvestorID: str
    DesignateRef: str
    UserID: str
    DesignateType: int
    DesignateLocalID: str
    ExchangeID: str
    ParticipantID: str
    ClientID: str
    TraderID: str
    ...
    ...
class CThostFtdcQryDesignateField:
    BrokerID: str
    InvestorID: str
    ExchangeID: str
    
    ...
class CThostFtdcExchangeDesignateField:
    DesignateType: int
    DesignateLocalID: str
    ExchangeID: str
    ParticipantID: str
    ...
    ...
class CThostFtdcInputStockDisposalField:
    BrokerID: str
    InvestorID: str
    StockDisposalRef: str
    UserID: str
    InstrumentID: str
    Volume: int
    StockDisposalType: int
    ExchangeID: str
    
    ...
class CThostFtdcStockDisposalField:
    BrokerID: str
    InvestorID: str
    StockDisposalRef: str
    UserID: str
    ...
    ...
class CThostFtdcQryStockDisposalField:
    BrokerID: str
    InvestorID: str
    ExchangeID: str
    
    ...
class CThostFtdcExchangeStockDisposalField:
    Volume: int
    StockDisposalType: int
    StockDisposalLocalID: str
    ExchangeID: str
    ...
    ...
class CThostFtdcQryInvestorLevelField:
    BrokerID: str
    InvestorID: str
    ExchangeID: str
...
class CThostFtdcForQuoteParamField:
    ...
    ...
class CThostFtdcQryExecFreezeField:
    BrokerID: str
    InvestorID: str
    InstrumentID: str
    ExchangeID: str
    ...
    ...
class CThostFtdcExecFreezeField:
    InstrumentID: str
    ExchangeID: str
    BrokerID: str
    InvestorID: str
...
class CThostFtdcCFMMCTradingAccountTokenField:
    ...
    ...
class CThostFtdcInstructionRightField:
    BrokerID: str
    ExchangeID: str
    InvestorID: str
    InstructionRight: int
    IsForbidden: int
...
class CThostFtdcTradingAccountReserveField:
    ...
    ...
class CThostFtdcDBFRecordField:
    DBFComdType: str
    DBFComTime: str
    DBFOComNo: str
    DBFComNo: str
...
class CThostFtdcTraderSpi:
    ...
    def OnRspLockInsert(self, 
            pInputLock: CThostFtdcInputLockField,
            pRspInfo: CThostFtdcRspInfoField,
            nRequestID: int,
            bIsLast: bool,
        ) -> None:
    ...
    def OnRspQryLock(self, 
            pLock: CThostFtdcLockField,
            pRspInfo: CThostFtdcRspInfoField,
            nRequestID: int,
            bIsLast: bool,
        ) -> None:
    ...
    def OnRspQryLockPosition(self, 
            pLockPosition: CThostFtdcLockPositionField,
            pRspInfo: CThostFtdcRspInfoField,
            nRequestID: int,
            bIsLast: bool,
        ) -> None:
    ...
    def OnRspQryInvestorLevel(self, 
            pInvestorLevel: CThostFtdcInvestorLevelField,
            pRspInfo: CThostFtdcRspInfoField,
            nRequestID: int,
            bIsLast: bool,
        ) -> None:
    ...
    def OnRspQryExecFreeze(self, 
            pExecFreeze: CThostFtdcExecFreezeField,
            pRspInfo: CThostFtdcRspInfoField,
            nRequestID: int,
            bIsLast: bool,
        ) -> None:
...
class CThostFtdcTraderApi:
    ...
    def ReqQryLock(self, 
            pQryLock: CThostFtdcQryLockField,
            nRequestID: int,
        ) -> int:
        
        ...
    
    def ReqQryLockPosition(self, 
            pQryLockPosition: CThostFtdcQryLockPositionField,
            nRequestID: int,
        ) -> int:
        
        ...
    
    def ReqQryInvestorLevel(self, 
            pQryInvestorLevel: CThostFtdcQryInvestorLevelField,
            nRequestID: int,
        ) -> int:
        
        ...
    
    def ReqQryExecFreeze(self, 
            pQryExecFreeze: CThostFtdcQryExecFreezeField,
            nRequestID: int,
        ) -> int:
...
THOST_FTDC_PC_ETFOption: int = 55
THOST_FTDC_PC_Stock: int = 56
...
THOST_FTDC_OPT_BestPriceThisSide: int = 72
...
THOST_FTDC_EIDT_SSE: int = 65
THOST_FTDC_EIDT_SZSE: int = 69
...
THOST_FTDC_LCKT_Lock: int = 49
THOST_FTDC_LCKT_Unlock: int = 50
THOST_FTDC_BZTP_Future: int = 49
THOST_FTDC_BZTP_Stock: int = 50
THOST_FTDC_DSTP_Register: int = 49
THOST_FTDC_DSTP_Cancel: int = 50
THOST_FTDC_FRTP_Init: int = 49
THOST_FTDC_FRTP_Lock: int = 50
THOST_FTDC_FRTP_Exec: int = 51
THOST_FTDC_FRTP_Check: int = 52
THOST_FTDC_FRTP_ExecFreeze: int = 53
THOST_FTDC_FZTP_Freeze: int = 49
THOST_FTDC_FZTP_Unfreeze: int = 50
THOST_FTDC_FZTP_Force: int = 51
THOST_FTDC_TSTP_Unknow: int = 48
THOST_FTDC_TSTP_Future: int = 49
THOST_FTDC_TSTP_IShare: int = 50
THOST_FTDC_STPT_ToBroker: int = 49
THOST_FTDC_STPT_ToInvestor: int = 50
THOST_FTDC_SDPS_Submitted: int = 97
THOST_FTDC_SDPS_Accepted: int = 98
THOST_FTDC_SDPS_Rejected: int = 99
THOST_FTDC_SDPS_Cancelled: int = 100
THOST_FTDC_ISTR_Limit: int = 49
THOST_FTDC_ISTR_Limit_FOK: int = 50
THOST_FTDC_ISTR_Market_RemainLimit: int = 51
THOST_FTDC_ISTR_Market_FAK: int = 52
THOST_FTDC_ISTR_Market_FOK: int = 53
THOST_FTDC_ISTR_Lock: int = 54
THOST_FTDC_ISTR_Unlock: int = 55
THOST_FTDC_IVLV_FirstLevel: int = 49
THOST_FTDC_IVLV_SecondLevel: int = 50
THOST_FTDC_IVLV_ThirdLevel: int = 51
